...
processing_function_version_one <- function() {
  #drop irrelevant observations:
    #test response(s) 
      drop if RESPONSEID=="R_1myHhk3o8mAi0GY"  sdfl;kjsadf;ljkjkl;
  ...
  #combine 1004's two partial responses (use 6/9 response for beginning-MHC_NEEDCURR and 6/19 response for DERS through end of BL)  
...
adapter_function_version_one <- function() {
  #drop variables not in version two
    recipientlastname recipientfirstname recipientemail externalreference site literacyscreen consentcomp consent desrim_exps_0-discrim_reasons_12 lifesex_online-mosex_online_prop exchsex_ever exchsex_ever_forwhat exchsex_ever_forced exchsex_3mo_app q525
  ...
  #recode values to match version two (originally for v4, double check...)
